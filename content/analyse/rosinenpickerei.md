...
gesetze_vorlagen: []
these: >-
  Die Schweiz wird unfairerweise für ihre selektive Auswahl von EU-Verträgen
  kritisiert, obwohl dies in anderen Lebensbereichen als normal und notwendig
  angesehen wird.
zusammenfassung: >-
  Der Artikel kritisiert den Begriff 'Rosinenpickerei', der oft verwendet wird,
  um die Schweiz für ihre selektive Auswahl von EU-Verträgen zu kritisieren. Der
  Autor argumentiert, dass dies in anderen Lebensbereichen, wie bei der Auswahl
  von Obst oder der Einstellung von Mitarbeitern, als normal und notwendig
  angesehen wird. Der Artikel fordert, dass die Schweiz ihre Souveränität und
  ihre Fähigkeit, selektiv zu wählen, respektiert wird.
---
