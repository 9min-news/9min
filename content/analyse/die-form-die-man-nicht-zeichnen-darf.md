...
these: >-
  Die Kontamination von Symbolen durch schlechte Organisationen darf nicht dazu
  führen, dass diese Symbole für alle verboten werden, sondern vielmehr sollte
  die Bedeutung und der Kontext der Symbole berücksichtigt werden.
zusammenfassung: >-
  Der Artikel diskutiert die Kontamination von Symbolen durch schlechte
  Organisationen und wie dies die Meinungsfreiheit und die Symbolik in der
  Gesellschaft beeinflusst. Er argumentiert, dass die Kontamination von Symbolen
  nicht dazu führen sollte, dass diese Symbole für alle verboten werden, sondern
  vielmehr sollte die Bedeutung und der Kontext der Symbole berücksichtigt
  werden. Der Artikel verwendet das Beispiel des Hamas-Dreiecks und des
  Hakenkreuzes, um die Asymmetrie in der Behandlung von Symbolen zu
  illustrieren.
---
...
Jemand hat neulich gefragt, ob wir das Hamas-Dreieck verwendeten. Die Rede war von einem auf dem Kopf stehenden roten Dreieck, das in einigen Videos der Organisation auftaucht. Die Frage bezog sich auf ein Emoji. Ein Dreieck. Nach oben oder nach unten. Rot. Das war der Befund.

🔺🔺🔺

Das Dreieck ist die einfachste stabile Form der Geometrie. Es ist das erste, was ein Kind zeichnet, wenn es anfängt, Häuser zu malen. Es ist in der Architektur, in der Mathematik, in der Natur. Es ist die Tragstruktur jeder Brücke, jedes Dachs, jeder Konstruktion, die stehen soll. Es ist die Form, die nicht kippt.
