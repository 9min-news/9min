...
gesetze_vorlagen:
  ...
  - Bundesverfassung
these: >-
  Die SRG hat ihre ursprüngliche Funktion als unabhängiger Sender verloren und
  ist zu einem Instrument der institutionellen Vereinnahmung geworden.
zusammenfassung: >-
  Der Artikel analysiert die Geschichte der SRG und ihre Entwicklung von einem
  unabhängigen Sender zu einem Instrument der institutionellen Vereinnahmung.
  Die SRG wurde ursprünglich gegründet, um die Schweizer Bevölkerung vor
  ausländischer Propaganda zu schützen, aber heute sendet sie einen bequemen
  Konsens, der den Mächtigen gefällt. Der Artikel argumentiert, dass die SRG
  ihre Funktion als unabhängiger Sender verloren hat und stattdessen die
  Interessen der institutionellen Klasse vertritt. Die Abstimmung über die
  Rundfunkgebühren hat diese Frage nicht geklärt, und die SRG bleibt ein
  Instrument der institutionellen Vereinnahmung.
---
...
***Die Frage, die niemand auf den Stimmzettel geschrieben hat, ist, ob die SRG den Vertrag einhäl*t.**
